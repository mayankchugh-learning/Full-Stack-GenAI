...
- Notebook **`classical_word_embedding`** (see `12Apr26`): load **gensim** downloader model **`word2vec-google-news-300`** — large, pretrained **KeyeVectors**; illustrates **analogies** and similarity.
...
- For notebook details, cell order, and training a **small custom** Word2Vec, use **`12Apr26/Notes.md`** as the primary in-repo study guide.
