...
**Source:** `m_Recording.transcript (1).vtt` — content below synthesizes this transcript with the notebooks in this folder (see also [`../08-Day-11Apr26/Notes.md`](../08-Day-11Apr26/Notes.md) for the paired session).
...
- `09-Day-12Apr26/Class-06-11-Apr-handwritten-notes-word2vec.pdf` — 26 pages; scanned/handwritten style (no selectable text extracted). Notes use transcript + manual page review where available.
- `09-Day-12Apr26/Class-07-12-Apr-handwritten-notes.pdf` — 38 pages; scanned/handwritten style (no selectable text extracted). Notes use transcript + manual page review where available.
