...
|--------|---------------------|---------|-------------------------|-----------|------|
| `01-Day-15Mar26` | `session_Recording.cutfile.20260316041451852.transcript.vtt` | [x] | [`Notes.md`](01-Day-15Mar26/Notes.md) | [x] | [x] |
| `02-Day-22Mar26` | `Recording.transcript.vtt` | [x] | [`Notes.md`](02-Day-22Mar26/Notes.md) | [x] | [x] |
| `03-Day-28Mar26` | `Session_Recording.cutfile.20260329093221035.transcript.vtt` | [x] | [`Notes.md`](03-Day-28Mar26/Notes.md) | [x] | [x] |
| `04-Day-29Mar26` | `modern _Recording.transcript.vtt` | [x] | [`Notes.md`](04-Day-29Mar26/Notes.md) | [x] | [x] |
| `05-Day-04Apr26` | `session_Recording.cutfile.20260405061846817.transcript.vtt` | [x] | [`Notes.md`](05-Day-04Apr26/Notes.md) + [`session_04Apr26_encoding_embedding_notes.md`](05-Day-04Apr26/session_04Apr26_encoding_embedding_notes.md) | [x] | [x] |
| `06-Day-05Apr26` | `GMT20260405-142945_Recording.transcript.vtt` | [x] | [`Notes.md`](06-Day-05Apr26/Notes.md) | [x] | [x] |
| `07-Day-09Apr26` | — | [ ] | _add when transcript exists_ | [ ] | [ ] |
| `08-Day-11Apr26` | `_Recording.transcript.vtt` | [x] | [`Notes.md`](08-Day-11Apr26/Notes.md) | [x] | [x] |
| `09-Day-12Apr26` | `m_Recording.transcript (1).vtt` | [x] | [`Notes.md`](09-Day-12Apr26/Notes.md) | [x] | [x] |
...
|--------|---------------|-------------------|-----------|---------|--------------|
| `01-Day-15Mar26` | `00:00:01.663` | `04:24:26.683` | `04:46:13.193` | `05:18:10.722` | `00:31:57.529` |
| `02-Day-22Mar26` | `00:00:52.590` | `04:45:16.739` | `04:56:23.160` | `05:15:48.490` | `00:19:25.330` |
| `03-Day-28Mar26` | `00:00:09.627` | `03:57:54.906` | `04:02:54.307` | `04:57:53.696` | `00:54:59.389` |
| `04-Day-29Mar26` | `00:02:56.640` | `04:47:36.430` | `05:08:34.850` | `05:08:45.779` | `00:00:10.929` |
| `05-Day-04Apr26` | `00:00:07.859` | `04:09:58.099` | `04:49:25.969` | `05:27:02.968` | `00:37:36.999` |
| `06-Day-05Apr26` | `00:06:58.290` | `03:51:13.989` | `04:14:02.810` | `04:39:00.160` | `00:24:57.350` |
| `08-Day-11Apr26` | `00:03:40.000` | `04:43:16.500` | `04:43:15.770` | `04:46:24.929` | `00:03:09.159` |
| `09-Day-12Apr26` | `00:06:30.020` | `03:56:03.860` | `04:04:20.460` | `04:07:57.949` | `00:03:37.489` |
...
| `07-Day-09Apr26` | Placeholder `Notes.md` only until you add session materials (no `.vtt` when last checked). |
