...
- Session conclusion time (teaching concluded cue): `02:35:00.820`
- Q&A segment: `02:35:00.820` to `04:08:24.640` (`01:33:23.820`)
- Full recording span (`.vtt` first cue to last cue): `04:00:12.880`

Note: `02:35:00.820` is used as the class-to-Q&A boundary.
...
## Materials in this folder (`12-Day-25Ap26/`)
...
- `12-Day-25Ap26/Class-10-25-Apr-Handwritten-notes.pdf` — 12 pages; scanned/handwritten style (no selectable text in direct extraction). Notes updated using page-by-page visual review plus transcript alignment.
